...
<section class="products-grids trending pb-4 mt-5 mb-5">
    ...
    <div class="container">
        <div class="card">
          <div class="card-body">
            Jumlah pembayaran yang harus anda lakukan adalah sebanyak <label style="font-weight:bold"><?= "Rp " . number_format($bayar['jumlah_pembayaran'],0,',','.'); ?></label> dengan invoice / kode order : <label style="font-weight: bold;"><?= $bayar['kode_order'] ?></label>.   Anda dapat melakukan pembayaran ke nomor rekening ini  : <label style="font-weight: bold;">BCA 647577111 a/n PT SINAR ANEKA NIAGA </label> dengan jumlah pembayaran yang sudah di tentukan di atas.<p></p>
