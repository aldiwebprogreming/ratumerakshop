                    ...
                    <?php foreach ($order as $data) { ?>
                        ...
                        foreach ($order_list as $val) { ?>
                            ...
                            <div class="col-sm-9 col-9">
                                <p class="fl. ,m m oat-right" style="font-weight: bold;">#<?= $data['kode_order'] ?></p>
                             ...
                             <a href="" class="btn btn-success btn-sm">Lakukan pembayaran <i class="fa fa-handshake-o" aria-hidden="true"></i></a>
                         </div>
